...
describe('groupMessageService', () => {
  describe('Unit Testing', () => {
    ...
    it('should be defined', () => {
      expect(groupMessageService).toBeDefined();
    });
    ...
    it('should create message and return record', async () => {
      ...
      const createdMessage = await groupMessageService.create(
        createMessageDto,
        '1',
      );
    ...
    it('should return exception if group id not found when create message', async () => {
      ...
      await expect(
        groupMessageService.create(createMessageDto, '1'),
    ...
    it('should update message and return record', async () => {
      ...
      const updatedMessage = await groupMessageService.update(
        updateMessageDto,
        '1',
      );
    ...
    it('should return exception if group id not found when update message', async () => {
      ...
      await expect(
        groupMessageService.update(updateMessageDto, '1'),
      ).rejects.toThrowError(new WsException('group not found'));
    });
    ...
    it('should find all message', async () => {
      ...
      const foundMessage = await groupMessageService.findAll(FindMessageDto);
    ...
    it('should return empty array if message not found', async () => {
      ...
      const messageFound = await groupMessageService.findAll(FindMessageDto);
    ...
    it('should remove message', async () => {
      ...
      await expect(
        groupMessageService.delete(['1'], '1', '1'),
    ...
    it('should return exception if message that need to be remove not found', async () => {
      ...
      await expect(
        groupMessageService.delete(['not_exist'], '1', '1'),
    ...
    it('should return exception if group id is not found', async () => {
      ...
      await expect(
        groupMessageService.delete(['1'], 'not_exist', '1'),
      ).rejects.toThrowError(new NotFoundException());
    });
  });
  ...
  describe('Integration Testing', () => {
    ...
    beforeAll(async () => {
      const module: TestingModule = await Test.createTestingModule({
        ...
        providers: [GroupMessageService, GroupMessageService],
      }).compile();

      prismaService = module.get<PrismaService>(PrismaService);
      groupMessageService =
        module.get<GroupMessageService>(GroupMessageService);
    });
    ...
    it('should return exception if sender id is not found when create message', async () => {
      ...
      await expect(
        groupMessageService.create(createMessageDto, 'not_found'),
    ...
    it('should return exception if group id is not found when create message', async () => {
      ...
      await expect(
        groupMessageService.create(createMessageDto, anto.id),
      ).rejects.toThrowError();
    });
    ...
    it('should return exception if sender id is not found when update message', async () => {
      ...
      await expect(
        groupMessageService.update(updateMessageDto, 'not_exist'),
      ).rejects.toThrowError();
    });
    ...
    it('should return exception if group id is not found when update message', async () => {
      ...
      await expect(
        groupMessageService.update(updateMessageDto, anto.id),
      ).rejects.toThrowError();
    });
    ...
    it('should remove message', async () => {
      ...
      await expect(
        groupMessageService.delete([message.id], group.id, anto.id),
      ).resolves.toBeUndefined();
    });
